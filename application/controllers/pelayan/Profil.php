...
class Profil extends MY_Controller
{
    ...
    public function index()
    {
        $data = [
            'title' => 'Profil',
            'content' => 'pelayan/profil/view',
            'data'    => $this->m_users->getRoleUsers('pelayan', $this->users->id_users),
            'css'     => 'pelayan/profil/css/view',
            'js'      => 'pelayan/profil/js/view'
        ];
        // untuk load view
        $this->load->view('pelayan/base', $data);
    }
    ...
    public function upd_akun()
    {
        ...
        $this->crud->u('tb_pelayan', $pelayan, ['id_users' => $this->users->id_users]);
        ...
        $this->crud->u('tb_users', $users, ['id_users' => $this->users->id_users]);
        $this->db->trans_complete();
        if ($this->db->trans_status() === FALSE) {
            $response = ['title' => 'Gagal!', 'text' => 'Gagal Simpan!', 'type' => 'error', 'button' => 'Ok!'];
        } else {
