...
class Profil extends MY_Controller
{
    ...
    public function index()
    {
        $data = [
            'title' => 'Profil',
            'content' => 'kurir/profil/view',
            'data'    => $this->m_users->getRoleUsers('kurir', $this->users->id_users),
            'css'     => 'kurir/profil/css/view',
            'js'      => 'kurir/profil/js/view'
        ];
        // untuk load view
    ...
    public function upd_akun()
    {
        ...
        $this->crud->u('tb_kurir', $kurir, ['id_users' => $this->users->id_users]);
