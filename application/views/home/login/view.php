            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <img src="<?= (empty($pengaturan->logo) ? "//placehold.it/150" : upload_url('gambar') . '' . $pengaturan->logo) ?>" alt="<?= (empty($pengaturan->nama) ? 'Logo' : $pengaturan->nama) ?>" width="75" height="75">
                    </div>
                            ...
                            <div class="row m-t-25 text-left">
                                <div class="col-12">
                                    <div class="forgot-phone text-left float-left">
                                        <a href="<?= register_url() ?>" class="text-left f-w-600">Buat Akun ?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row m-t-30">
                                <div class="col-md-12">
                                    <?= form_input(array('type' => 'submit', 'name' => 'login', 'value' => 'Masuk', 'id' => 'login', 'class' => 'btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20')) ?>
