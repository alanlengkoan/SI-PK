...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>ongkir/process_save" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpidongkir" id="inpidongkir" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="inplokasi" id="inplokasi" placeholder="Masukkan lokasi pengiriman" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Tarif&nbsp;*</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="inptarif" id="inptarif" onkeydown="return justAngka(event)" onkeyup="javascript:this.value=autoSeparator(this.value);" placeholder="Masukkan tarif pengiriman" />
                        </div>
                    </div>
                </div>
