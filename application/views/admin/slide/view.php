            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped table-bordered nowrap" id="tabel-slide"></table>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>slide/process_save" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpidslide" id="inpidslide" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="inpjudul" id="inpjudul" placeholder="Masukkan judul gambar" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Diskon&nbsp;*</label>
                        <div class="col-sm-10">
                            <select class="form-control" name="inpiddiskon" id="inpiddiskon">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="inpstatus" id="inpstatus">
