...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>stok/process_save" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpidstock" id="inpidstock" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="inpstock" id="inpstock" placeholder="Masukkan jumlah stock" />
                        </div>
                    </div>
                </div>
