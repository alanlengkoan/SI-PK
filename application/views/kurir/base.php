...
<body>
    ...
    <script type="text/javascript">
        ...
        function load_notification() {
            $.ajax({
                type: 'GET',
                url: '<?= kurir_url() ?>dashboard/load_notification',
                dataType: 'json',
        ...
        $(document).on('click', '.lihat', function() {
            ...
            $.post('<?= kurir_url() ?>dashboard/read_notification', {
                kd_pemesanan: ini.data('id')
            });

            location.href = '<?= kurir_url() ?>pemesanan/detail/' + btoa(kd_pemesanan);
        });
